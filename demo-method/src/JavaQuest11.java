...
public class JavaQuest11 {
  ...
  public static int findDelayedArrivalTime(int arrivalTime, int delayedTime) {
    int theDelayedTime=0;
    if((arrivalTime+delayedTime)>=24){
      theDelayedTime= arrivalTime+delayedTime-24;
    }else{theDelayedTime=arrivalTime+delayedTime;}
    System.out.println(theDelayedTime);
    // code here ...
        return theDelayedTime;
  }
